...
class PenguinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create penguin" do
    assert_difference('Penguin.count') do
      post penguins_url, params: { penguin: { colour: @penguin.colour, height: @penguin.height, name: @penguin.name, weight: @penguin.weight } }
    end
  ...
  test "should update penguin" do
    patch penguin_url(@penguin), params: { penguin: { colour: @penguin.colour, height: @penguin.height, name: @penguin.name, weight: @penguin.weight } }
